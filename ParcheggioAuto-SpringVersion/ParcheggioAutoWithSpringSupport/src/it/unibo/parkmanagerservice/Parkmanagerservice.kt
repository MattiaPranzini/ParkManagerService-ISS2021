		...
		return { //this:ActionBasciFsm
				state("moveToHome") { //this:State
					action { //it:State
						...
						updateResourceRep( "parkmanagerservice(start1)"  
						)
				...
				state("stopped") { //this:State
					action { //it:State
						...
						forward("cambiostato", "cambiostato($STATO)" ,"basicrobot" ) 
						}
				...
				state("receipt") { //this:State
					action { //it:State
						...
						forward("parcheggioOccupato", "parcheggioOccupato($RICEVUTA)" ,"basicrobot" ) 
						 PROGRESSIVO++  
				...
				state("acceptout") { //this:State
					action { //it:State
						...
						if(  outdoorLibera  
								...
								forward("parcheggioLibero", "parcheggioLibero($T)" ,"basicrobot" ) 
								println("Slot $T")
								}
								else
								 {forward("goto", "goto(home)" ,"parkmanagerservice" ) 
				...
				state("uscitalibera") { //this:State
					action { //it:State
						...
						forward("uscitalibera1", "uscitalibera1(V)" ,"basicrobot" ) 
					}
				...
				state("timeout") { //this:State
					action { //it:State
						println("ALARM")
						forward("timeout1", "timeout1(V)" ,"basicrobot" ) 
					}
